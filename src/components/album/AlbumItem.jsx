...
const Note = props => {
  console.log("33333eee3e3e3e3e3e3", props.json);
  // const text = await new Response(props.json).text();
...
export default class AlbumItem extends Component {
  ...
  loadJsonSuccess(data) {
    ...
    data.Body.text().then(dataJSONstring => {
      this.setState({ json: dataJSONstring });
    })
  }
